# 对照官方 phases/00-setup-and-tooling/05-jupyter-notebooks/code/notebook_tips.py
# 脚本版演示：list vs NumPy 计时、存图、DataFrame、内存。Notebook 里对应 %timeit / %%time / %matplotlib inline。
import time
import sys
